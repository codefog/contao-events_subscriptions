...
class SubscriptionFactory
{
    ...
    public function add($type, $class)
    {
        ...
        if (!$ref->implementsInterface('Codefog\EventsSubscriptionsBundle\Subscription\SubscriptionInterface')) {
            throw new \InvalidArgumentException(
                sprintf(
                    'The class "%s" must be an instance of \Codefog\EventsSubscriptionsBundle\Subscription\SubscriptionInterface',
                    $class
                )
            );
        }
