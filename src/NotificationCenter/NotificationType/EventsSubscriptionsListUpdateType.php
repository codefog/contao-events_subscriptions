...
class EventsSubscriptionsListUpdateType implements NotificationTypeInterface
{
    public const NAME = 'events_subscriptions_listUpdate';
    ...
    public function getTokenDefinitions(): array
    {
        return [
            ...
            $this->factory->create(TextTokenDefinition::class, 'unsubscribe_link', ''),
        ];
    }
}
