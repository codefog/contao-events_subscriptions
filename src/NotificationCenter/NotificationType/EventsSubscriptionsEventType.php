...
class EventsSubscriptionsEventType implements NotificationTypeInterface
{
    public const NAME = 'events_subscription_event';
    ...
    public function getTokenDefinitions(): array
    {
        return [
            ...
            $this->factory->create(AnythingTokenDefinition::class, 'member_*', ''),
